...
const _de = <String, String>{
  ...
  'group.menu': 'Mehr',
  'group.reply': 'Antworten',
  'group.replyTo': 'Antwort an {name}',
  'group.replyGone': 'Nachricht nicht mehr verfügbar',
  'group.you': 'Du',
  'group.copy': 'Kopieren',
  'group.copied': 'Nachricht kopiert.',
  'group.removeReaction': 'Reaktion entfernen',
  'group.reactFailed': 'Reaktion ging gerade nicht – bitte nochmal versuchen.',
  ...
  'feedback.subtitle':
      'Was gefällt dir, was fehlt, was klemmt? Jede Nachricht wird gelesen.',
  'feedback.category.idea': 'Idee',
  'feedback.category.bug': 'Fehler',
  'feedback.category.praise': 'Lob',
  'feedback.category.other': 'Sonstiges',
  'feedback.category.test': 'Testprotokoll',
  'feedback.hint': 'Deine Nachricht …',
  'feedback.send': 'Absenden',
  'feedback.thanks': 'Danke für dein Feedback! 💚',
  'feedback.failed': 'Feedback konnte nicht gesendet werden: {error}',
  'admin.admins': 'Admins',
  'admin.adminsHint': 'Admins sehen diese Ansicht mit allen Meldungen und allem Feedback. Ernenne nur Personen, denen du vertraust.',
  'admin.addButton': 'Admin hinzufügen',
  'admin.addTitle': 'Admin hinzufügen',
  'admin.addConfirm': '{name} kann danach alle Meldungen, Feedbacks und Konto-Gründe sehen und selbst Admins ernennen. Fortfahren?',
  'admin.add': 'Ernennen',
  'admin.removeTitle': 'Admin entfernen?',
  'admin.removeConfirm': '{name} ist danach kein Admin mehr.',
  'admin.remove': 'Entfernen',
  'admin.lastAdmin': 'Es muss immer mindestens einen Admin geben.',
  'admin.changeFailed': 'Konnte nicht geändert werden: {error}',
  'admin.searchHint': 'Name suchen …',
  'admin.you': '{name} (du)',
  'admin.title': 'Meldungen & Feedback',
  'admin.subtitle': 'Nur für dich sichtbar · als Excel exportierbar',
  'admin.refresh': 'Aktualisieren',
  'admin.export': 'Als Excel (CSV) herunterladen',
  'admin.exportUnavailable': 'Download geht nur in der Web-App.',
  'admin.reports': 'Meldungen',
  'admin.feedback': 'Feedback',
  'admin.accounts': 'Pausiert/Gelöscht',
  'admin.loadFailed': 'Konnte nicht geladen werden: {error}',
  'admin.reportTitle': '{reporter} meldet {reported}',
  'admin.reportCount': '{count}× gemeldet insgesamt',
  'admin.suspended': 'automatisch gesperrt',
  'admin.chatKept': 'Chat gespeichert',
  'admin.deletedAccount': 'Gelöschtes Konto',
  'admin.deleted': 'Konto gelöscht',
  'admin.paused': 'Konto pausiert',
  'admin.noReason': 'Kein Grund angegeben',
  'admin.empty': 'Noch nichts da.',
  'admin.done': 'Erledigt',
  'admin.new': 'Neu',
...
const _en = <String, String>{
  ...
  'group.menu': 'More',
  'group.reply': 'Reply',
  'group.replyTo': 'Replying to {name}',
  'group.replyGone': 'Message no longer available',
  'group.you': 'You',
  'group.copy': 'Copy',
  'group.copied': 'Message copied.',
  'group.removeReaction': 'Remove reaction',
  'group.reactFailed': 'Couldn\'t react right now – please try again.',
  ...
  'feedback.subtitle': 'What do you like, what\'s missing, what\'s broken? Every message gets read.',
  'feedback.category.idea': 'Idea',
  'feedback.category.bug': 'Bug',
  'feedback.category.praise': 'Praise',
  'feedback.category.other': 'Other',
  'feedback.category.test': 'Test protocol',
  'feedback.hint': 'Your message …',
  'feedback.send': 'Send',
  'feedback.thanks': 'Thanks for your feedback! 💚',
  'feedback.failed': 'Couldn\'t send feedback: {error}',
  'admin.admins': 'Admins',
  'admin.adminsHint': 'Admins see this view with all reports and feedback. Only appoint people you trust.',
  'admin.addButton': 'Add admin',
  'admin.addTitle': 'Add admin',
  'admin.addConfirm': '{name} will then see all reports, feedback and account reasons and can appoint admins too. Continue?',
  'admin.add': 'Appoint',
  'admin.removeTitle': 'Remove admin?',
  'admin.removeConfirm': '{name} will no longer be an admin.',
  'admin.remove': 'Remove',
  'admin.lastAdmin': 'There always has to be at least one admin.',
  'admin.changeFailed': 'Couldn\'t change: {error}',
  'admin.searchHint': 'Search by name …',
  'admin.you': '{name} (you)',
  'admin.title': 'Reports & feedback',
  'admin.subtitle': 'Only visible to you · exportable to Excel',
  'admin.refresh': 'Refresh',
  'admin.export': 'Download as Excel (CSV)',
  'admin.exportUnavailable': 'Downloading only works in the web app.',
  'admin.reports': 'Reports',
  'admin.feedback': 'Feedback',
  'admin.accounts': 'Paused/deleted',
  'admin.loadFailed': 'Couldn\'t load: {error}',
  'admin.reportTitle': '{reporter} reports {reported}',
  'admin.reportCount': 'reported {count}× in total',
  'admin.suspended': 'automatically suspended',
  'admin.chatKept': 'chat kept',
  'admin.deletedAccount': 'Deleted account',
  'admin.deleted': 'Account deleted',
  'admin.paused': 'Account paused',
  'admin.noReason': 'No reason given',

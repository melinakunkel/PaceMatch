...
const _de = <String, String>{
  ...
  'chatList.leaveConfirm': 'Du verlässt die Gruppe "{name}".',
  'chatList.leave': 'Verlassen',
  'chatList.deleteTitle': 'Chat löschen?',
  'chatList.deleteConfirm':
      'Die Gruppe "{name}" wird für alle Teilnehmer unwiderruflich gelöscht.',
  'chatList.archivedTitle': 'Archivierte Chats',
  'chatList.title': 'Gruppen & Chats',
  ...
  'chatList.emptyActive':
      'Noch keine Gruppen. Starte einen Chat über deine Sportbuddys.',
